                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <h5 class="card-header-item mb-0 d-flex justify-content-between" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
                                                ...
                                                <span class="accordion-hdtext"> Proin elementum tincidunt iaculis vestibulum eu dui ut purus aliquet tempor tristique ac leo? </span>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            <h5 class="card-header-item mb-0 d-flex justify-content-between collapsed" data-toggle="collapse" data-target="#collapseTwo"
                                                ...
                                                <span class="accordion-hdtext"> Donec sed massa dictum bibendum magna interdum? </span>
                                                <span class="accordion-indicator">
                                                    <i class="fas fa-plus"></i>
                                                    <i class="fas fa-minus"></i>
                                                </span>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingThree">
                                            <h5 class="card-header-item mb-0 d-flex justify-content-between collapsed" data-toggle="collapse" data-target="#collapseThree"
                                                ...
                                                <span class="accordion-hdtext"> Nullam turpis sapien condimentum ut iaculis ut? </span>
                                                <span class="accordion-indicator">
                                                    <i class="fas fa-plus"></i>
                                                    <i class="fas fa-minus"></i>
                                                </span>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingFour">
                                            <h5 class="card-header-item mb-0 d-flex justify-content-between collapsed" data-toggle="collapse" data-target="#collapseFour"
                                                aria-expanded="false" aria-controls="collapseFour">
                                                <span class="accordion-hdtext"> Massa dictum bibendum magna interdum? </span>
                                                <span class="accordion-indicator">
                                                    <i class="fas fa-plus"></i>
                                                    <i class="fas fa-minus"></i>
                                                </span>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingFive">
                                            <h5 class="card-header-item mb-0 d-flex justify-content-between collapsed" data-toggle="collapse" data-target="#collapseFive"
                                                aria-expanded="false" aria-controls="collapseFive">
                                                <span class="accordion-hdtext"> Turpis sapien condimentum ut iaculis ut? </span>
                                                <span class="accordion-indicator">
                                                    <i class="fas fa-plus"></i>
                                                    <i class="fas fa-minus"></i>
                                                </span>
