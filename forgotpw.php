    ...
    <div class="wrapper">
        ...
        <main role="main" class="login">
            ...
            <form class="form-userinput">
                ...
                <h1 class="h3 mt-5 mb-4 font-weight-normal">Forgot</h1>
                <label for="inputEmail" class="sr-only">Email address</label>
                <input type="email" id="inputEmail" class="form-control" placeholder="Email address" required="" autofocus="">
                <p><a href="#" class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam non vulputate ipsum, eu auctor magna.</a></p>
                <!-- <div class="checkbox mb-3">
                    <label>
                        <input type="checkbox" value="remember-me"> Remember me
                    </label>
                </div> -->
                <button class="btn btn-lg btn-primary btn-block btn-rounded mt-5" type="submit">Send</button>
                <br>
                <br>
